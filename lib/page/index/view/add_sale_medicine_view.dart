...
class AddSaleMedicineView extends StatelessWidget {
  final MedicineBean medicineBean;
  AddSaleMedicineView({Key? key, required this.medicineBean}) : super(key: key);
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  Get.back(result: SaleMedicineBean.fromMap({
                    "name":_nameTec.text,
                    "sale_price":double.parse(_salePriceTec.text),
                    "pur_price":double.parse(_purPriceTec.text),
                    "quantity":int.parse(_quantityTec.text),
                    "img":"暂无",
                  }));
                },
                child: Container(
